...
class SnapsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //to see all the snaps user received from
        FirebaseDatabase.getInstance("https://snapchat-clone-1f8f2-default-rtdb.asia-southeast1.firebasedatabase.app/")
            ...
            .addChildEventListener(object :
                ...
                override fun onChildAdded(snapshot: DataSnapshot, previousChildName: String?) {
                    ...
                    snaps.add(snapshot) //pass the snapshot data to snaps arrayList
        ...
        snapsListView?.onItemClickListener =
            AdapterView.OnItemClickListener { adapterView, view, position, index ->
